        ...
        return (
            <div className={styles.container}> 
                ...
                <div className={`${styles.row} ${styles.justifyContentCenter} ${styles.mt5}`}>
                    <div className={`${styles.col6} ${styles.colSm4} ${styles.colMd3} ${styles.colLg2} ${styles.textCenter}`} onClick={props.handleEndEdit}>
                        <p className={formStyles.submitBtn}>Submit</p>
                    </div>
                </div>
            </div>
        )
